...
echo "   - OVH_AI_ENDPOINTS_EMBEDDING_MODEL_NAME: " $OVH_AI_ENDPOINTS_EMBEDDING_MODEL_NAME
echo "   - OVH_AI_ENDPOINTS_SD_URL: " $OVH_AI_ENDPOINTS_SD_URL
echo "   - OVH_AI_ENDPOINTS_WHISPER_URL: " $OVH_AI_ENDPOINTS_WHISPER_URL
echo "   - OVH_AI_ENDPOINTS_WHISPER_MODEL: " $OVH_AI_ENDPOINTS_WHISPER_MODEL
echo "   - OVH_AI_ENDPOINTS_TTS_MODEL: " $OVH_AI_ENDPOINTS_TTS_MODEL
